...
class MRICORRECTOR:
    def __init__(self, input_filename, output_filename):
        ...
        self.output_filename = output_filename #'points_corrected.npz'  #numpy file to save the corrections
        self.window_size = [1200,800] #size for the render window
    ...
    def correct(self):
        ...
        mapper_endo.SetInputData(shape_endo)
        ...
        mapper_epi.SetInputData(shape_epi)
    ...
    def copy(self):
        npzfile = np.load(self.input_filename)
        np.savez(self.output_filename, npzfile)
